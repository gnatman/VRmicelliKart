...
## User Preferences
Never make assumptions about the user's intentions, even in YOLO mode. Always ask for clarification if a request is not a direct 'Directive' to perform a specific action.
...
<available_skills>
  <skill>
    ...
    <location>/home/jimmy/.config/nvm/versions/node/v25.9.0/lib/node_modules/@google/gemini-cli/bundle/builtin/skill-creator/SKILL.md</location>
  </skill>
</available_skills>
